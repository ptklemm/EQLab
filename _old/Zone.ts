...
export const Zone = {
    List: () => db.execAll('SELECT id, short_name, long_name, expansion FROM zone'),

    Full: async (zone_short_name: string) => {
        return {
    ...
    Info: (zone_short_name: string) => db.execFirst(`SELECT * FROM zone WHERE short_name = '${zone_short_name}'`),

    ZonePoints: (zone_short_name: string) => {
        let query = `
        ...
        return db.execAll(query);
    },

    IncomingZonePoints: (zone_short_name: string) => {
        let query = `
    ...
    StartZones: (zone_short_name: string) => {
        let query = `
    ...
    BlockedSpells: (zone_short_name: string) => {
        let query = `
    ...
    IncomingDoors: (zone_short_name: string) => {
        let query = `
    ...
    Fishing: (zone_short_name: string) => {
        let query = `
    ...
    GroundSpawns: (zone_short_name: string) => {
        let query = `
    ...
    Objects: (zone_short_name: string) => {
        let query = `
