...
class ZoneQueryList
{
    ...
    public async List()
    {
        return await this._db.execAll('SELECT id, short_name, long_name, expansion FROM zone');
    }

    public async Full(zone_short_name: string)
    {
        return {
    ...
    public async Info(zone_short_name: string)
    {
        return await this._db.execFirst(`SELECT * FROM zone WHERE short_name = '${zone_short_name}'`);
    }

    public async ZonePoints(zone_short_name: string)
    {
        let query = `
        ...
        return await this._db.execAll(query);
    }

    public async IncomingZonePoints(zone_short_name: string)
    {
        let query = `
    ...
    public async StartZones(zone_short_name: string)
    {
        let query = `
    ...
    public async BlockedSpells(zone_short_name: string)
    {
        let query = `
    ...
    public async Doors(zone_short_name: string)
    {
        let query = `
    ...
    public async IncomingDoors(zone_short_name: string)
    {
        let query = `
    ...
    public async Fishing(zone_short_name: string)
    {
        let query = `
    ...
    public async Forage(zone_short_name: string)
    {
        let query = `
    ...
    public async Grid(zone_short_name: string)
    {
        let query = `
        ...
        const results = await this._db.execAll(query);
        return new Treeize().grow(results).getData();
    }

    public async GroundSpawns(zone_short_name: string)
    {
        let query = `
    ...
    public async Objects(zone_short_name: string)
    {
        let query = `
    ...
    public async Spawns(zone_short_name: string)
    {
        let query = `
    ...
    public async Traps(zone_short_name: string)
    {
        let query = `
...
export default class DatabaseConnection
{
    ...
    public Spawn2:     StandardQueryList;
    public SpawnGroup: StandardQueryList; 
    public SpawnEntry: StandardQueryList;
    ...
    constructor(config: mysql.ConnectionConfig)
    {
        ...
        this.Spawn2     = new StandardQueryList(this, 'spawn2');
        this.SpawnGroup = new StandardQueryList(this, 'spawngroup');
        this.SpawnEntry = new StandardQueryList(this, 'spawnentry');
    }
    ...
    public Init(): DatabaseConnection
    {
        this.Zone       = new ZoneQueryList(this);
        this.Spawn2     = new StandardQueryList(this, 'spawn2');
        this.SpawnGroup = new StandardQueryList(this, 'spawngroup');
    ...
    public execAll(querystr: string): Promise<any>
    {
        return new Promise((resolve, reject) => {
    ...
    public execFirst(querystr: string): Promise<any>
    {
        return new Promise((resolve, reject) => {
            this._connection.query(querystr, (err, results) => {
                if (err)
